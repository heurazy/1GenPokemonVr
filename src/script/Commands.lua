...
function Commands.start_battle(ctx, kind, a, b)
  ...
  -- Script-driven fights must enter through the overworld's normal battle
  -- transition when one exists.  Besides restoring the flash/wipe and music
  -- timing, this is the seam Dramatic Shape wraps to prepare its 3D arena
  -- before the battle becomes visible.  Non-overworld callers (link/tests)
  -- keep the direct stack fallback they had before.
